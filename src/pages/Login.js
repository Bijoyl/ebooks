...
export const Login = () => {
  ...
  async function handleLoginGuest() {
    email.current.value = process.env.REACT_APP_GUEST;
    password.current.value = process.env.REACT_APP_GPASSWORD;
  ...
  return (
    <main>
      <div classNmae="min-h-screen flex items-center justify-center bg-gray-100">
      <section >
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" className="text-white align-middle bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log In</button>
        </form>
