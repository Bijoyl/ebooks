...
import { ProductRating } from "../components/Elements/ProductRating";
import { useTitle } from "../hooks/useTitle";
import { useCart } from "../context";
import { productItem } from "../utilities";
      ...
      <section>
        ...
        <div className="flex flex-wrap justify-around">
          ...
          <div className="max-w-xl my-3">
            ...
            <p className="my-3">
              {!inCart && product.in_stock && <button onClick={() => addToCart(product)} className={`inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800`}>Add To Cart <i className="ml-1 bi bi-plus-lg"></i></button>}
              {!product.in_stock && <button type="button" className="text-white bg-blue-400 dark:bg-blue-500 cursor-not-allowed font-medium rounded-lg text-sm px-5 py-2.5 text-center" disabled>Unavailable</button>}
