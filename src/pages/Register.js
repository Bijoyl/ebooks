...
export const Register = () => {
  ...
  const navigate = useNavigate();
    async function handleRegister(event)
    {
      ...
      try{
        const data = await register(regDetails );
          ...
          <section>
            ...
            <div className="mb-6">
              ...
              <div className="mb-6">
                  ...
                  <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="test@test.com" required autoComplete="off" />
              </div>
              <div className="mb-6">
            ...
            <p className="dark:text-slate-300">Already registerd?</p><button type="submit" onClick={handleLogin} className="text-white my-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log In</button>
        </main>
      )
}
